...
class Posts extends CI_Controller {
	...
	// or
		...
		public function consult($pacient_id) {
			$aa='consult';
			die($pacient_id);
		}
	...
	if(($this->form_validation->run() === FALSE ) and ($select_criteriu != 'cnp_name_nr')) {
        	...
        	$this->load->view('posts/patient/search_patient', $data);
             ...
             $this->session->set_userdata('select_criteriu', $this->input->post('select_criteriu'));
             $this->session->set_userdata('cnp', $this->input->post('cnp'));
             ...
             $this->session->set_userdata('patient_number', $this->input->post('patient_number'));
