      ...
      <div class="panel panel-info card" >
       ...
       <div style="margin-bottom: 5px; padding: 6px 12px;" class="input-group">
            ...
            <select name="select_criteriu" class="form-control" id="select_criteriu">
                  ...
                  <option value="cnp_name_nr">First Name, Second Name, Cnp, Patient number</option>
            </select>
         </div>
...
<!-- last name --> 
    ...
    <!-- pacient_nr --> 
            <div style="margin-bottom: 5px; padding: 6px 12px;" class="input-group">
              <span class="addon"><i class="fas fa-user-alt"></i></span>
              <input id="patient_number" type="number" step="1" class="form-control" name="patient_number" value="" placeholder="patient number">            
            </div>
 ...
 <script type="text/javascript">
      ...
      $(document).ready(function(){ //1  (aa
        ...
        if($criteriu == 'name')
        { //3
          document.getElementById("mesaj_criteriu").innerHTML = "<b>"+"Search after First Name and Last Name"+"</b>";      
           ...
           $('#search').prop('disabled', false);
               ...
               { //4
                ...
                { //5
                  document.getElementById("mesaj_criteriu").innerHTML = "<b>"+"Search after First Name, Last Name, CNP, Patient_number"+"</b>";
                $('#first_name').prop('disabled', false);
                $('#last_name').prop('disabled', false);
                $('#cnp').prop('disabled', false);
